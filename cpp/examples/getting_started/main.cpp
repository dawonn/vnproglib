...
// 	vs.unregisterAsyncPacketReceivedHandler();
    ...
    configBO1.asyncMode = (vn::protocol::uart::AsyncMode)(3); 
    configBO1.rateDivisor = 200; 
    configBO1.commonField = (vn::protocol::uart::CommonGroup)(9); 
    configBO1.timeField = (vn::protocol::uart::TimeGroup)(0); 
    configBO1.imuField = (vn::protocol::uart::ImuGroup)(0); 
    configBO1.gpsField = (vn::protocol::uart::GpsGroup)(0); 
    configBO1.attitudeField = (vn::protocol::uart::AttitudeGroup)(0); 
    configBO1.insField = (vn::protocol::uart::InsGroup)(0); 
    configBO1.gps2Field = (vn::protocol::uart::GpsGroup)(0); 
